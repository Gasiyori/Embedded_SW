import pandas as pd     # process excel-style data
import numpy as np      # process matrix data 
import seaborn as sns   # draw graph
import matplotlib.pyplot as plt # draw graph
from sklearn import model_selection # split training data and verifying data
